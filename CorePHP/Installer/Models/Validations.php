...
class Validations
{
     ...
     */
    public static function isText(string $field): bool
    {
     ...
     */
    public static function isData(string $field): bool
    {
     ...
     */
    public static function isPrimary(string $field): bool
    {
        return $field == "PRI";
    }
     ...
     */
    public static function isAutoIncrement(string $field): bool
    {
     ...
     */
    public static function getPrimaryField(array $fields): string
    {
     ...
     */
    public static function checkFieldExists(string $check, array $fields): bool
    {
        foreach($fields as $field){
            if($field[0] == $check){
                return true;
