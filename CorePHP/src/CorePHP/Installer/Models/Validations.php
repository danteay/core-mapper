...
class Validations
{
     ...
     */
    public static function isNumeric(string $field)
    {
     ...
     */
    public static function isText(string $field)
    {
     ...
     */
    public static function isData(string $field)
    {
     ...
     */
    public static function isPrimary(string $field)
    {
        return $field == "PRI";
    }
     ...
     */
    public static function isAutoIncrement(string $field)
    {
     ...
     */
    public static function checkFieldExists(string $check, array $fields)
    {
        foreach($fields as $field){
            if($field[0] == $check){
                return true;
